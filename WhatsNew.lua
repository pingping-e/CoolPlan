...
local BODY = {
  en = table.concat({
    "Version update — the 6 phase-shifting bosses now follow your cooldown plan correctly.",
    "",
    "Affected bosses:",
    ...
    "",
    "|cffffcc00Important:|r only these bosses' plans need a refresh from the site (re-grabbing all is fine too — other bosses are unaffected).",
    "",
    "Not working, or seeing an error? Tell us on Discord and we'll fix it quickly.",
    "",
